...
from fasthep_carpenter.protocols import DataMapping
from fasthep_carpenter.testing import DummyMapping
...
def test_expression_with_func_and_slice(dummy_mapping, register_functions):
